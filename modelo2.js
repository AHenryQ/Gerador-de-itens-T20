function fabArms(nome,substantivo,preco,peso,Fogo,vroll,troll,xCrit,rCrit,tipo=0,alc=0,pass=0){
    alarr=["-",9,30,90];
...
function modificadores(arma,num=Number(rand([1,19]))){
    ...
    if(arma.alcance=="-"||(arma.alcance<10&&arma.deFogo==false)||!!arma.melAlc==true){
        modificadores(arma)
